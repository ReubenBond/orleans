...
namespace Orleans.Legacy.Serialization
{
    internal static class SerializerFeatureExtensions
    {
        ...
        public static void AddSerializerDelegates(this SerializerFeature serializerFeature, Type type, Copier copier, Serializer serializer, Deserializer deserializer)
        {
        ...
        public static void AddSerializerDelegates(this SerializerFeature serializerFeature, Type type, Copier copier, Serializer serializer, Deserializer deserializer, bool overrideExisting)
        {
