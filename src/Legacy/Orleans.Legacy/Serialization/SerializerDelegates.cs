...
namespace Orleans.Legacy.Serialization
{
    ...
    public delegate object Copier(object original, ICopyContext context);
    ...
    {
        public SerializerMethods(Copier deepCopy, Serializer serialize, Deserializer deserialize)
        {
