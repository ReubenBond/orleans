namespace Orleans.Legacy.Serialization
{
    ...
    internal class ReflectedSerializationMethodInfo
    {
        ...
        /// <summary>
        /// The <see cref="MethodInfo"/> for the <see cref="Copier"/> delegate.
        /// </summary>
        ...
        public ReflectedSerializationMethodInfo()
        {
            ...
            this.DeepCopierDelegate = TypeUtils.Method((Copier del) => del.Invoke(default(object), default(ICopyContext)));
        }
    }
}