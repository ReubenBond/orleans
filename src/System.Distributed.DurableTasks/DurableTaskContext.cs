...
public abstract partial class DurableExecutionContext(TaskId id)
{
    ...
    protected internal abstract ValueTask<DurableTaskResponse> ScheduleChildTaskAsync(TaskId taskId, DurableTask taskDefinition, CancellationToken cancellationToken);
