...
public readonly struct DurableTaskResultAwaitable<TResult>(DurableTaskExecutionContext executionContext)
{
    private readonly DurableTaskExecutionContext _executionContext = executionContext;
