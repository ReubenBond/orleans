    ...
    public class OrleansSerializationSourceGenerator : ISourceGenerator
    {
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            try
            {
                ...
                {
                    options.ImmutableAttributes.AddRange(immutableAttributes.Split(Separator, StringSplitOptions.RemoveEmptyEntries).ToList());
                }
                ...
                {
                    options.AliasAttributes.AddRange(aliasAttributes.Split(Separator, StringSplitOptions.RemoveEmptyEntries).ToList());
                }
                ...
                {
                    options.IdAttributes.AddRange(idAttributes.Split(Separator, StringSplitOptions.RemoveEmptyEntries).ToList());
                }
                ...
                {
                    options.GenerateSerializerAttributes.AddRange(generateSerializerAttributes.Split(Separator, StringSplitOptions.RemoveEmptyEntries).ToList());
                }
