...
{
    private static readonly Action<object?>? Signalling = _ => { };
    ...
    public ValueTaskSourceStatus GetStatus(short token)
    {
        ...
        var res = ReferenceEquals(continuation, Signalling) ? ValueTaskSourceStatus.Succeeded : ValueTaskSourceStatus.Pending;
        return res;
    }
    ...
    public void OnCompleted(Action<object?> continuation, object? state, short token, ValueTaskSourceOnCompletedFlags flags)
    {
        ...
        {
            Debug.Assert(ReferenceEquals(prevContinuation, Signalling));
            continuation(state);
        }
    }
    ...
    {
        Debug.Assert(token == _version);
        Debug.Assert(ReferenceEquals(_continuation, Signalling));
    ...
    public void Signal()
    {
        var continuation = Interlocked.Exchange(ref _continuation, Signalling);
        ...
        if (ReferenceEquals(continuation, Signalling))
        {
        ...
        Debug.Assert(!ReferenceEquals(continuation, Signalling));
        continuation(_state);
    }
