...
public class TlsOptions
{
    ...
    /// <summary>
    /// Specifies allowable SSL protocols. Defaults to <see cref="SslProtocols.Tls13" /> and <see cref="SslProtocols.Tls12" />.
    /// </summary>
    ...
    /// </summary>
    public Action<MessageTransport, TlsServerAuthenticationOptions>? OnAuthenticateAsServer { get; set; }

    /// <summary>
    /// Provides direct configuration of the <see cref="TlsClientAuthenticationOptions"/> on a per-connection basis.
    /// This is called after all of the other settings have already been applied.
    /// </summary>
    public Action<MessageTransport, TlsClientAuthenticationOptions>? OnAuthenticateAsClient { get; set; }

    /// <summary>
    /// Gets or sets the memory pool.
    /// </summary>
