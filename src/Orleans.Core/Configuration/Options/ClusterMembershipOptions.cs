...
namespace Orleans.Configuration
{
    ...
    public class ClusterMembershipOptions
    {
        ...
        /// <summary>
        /// Gets or sets the retention period after which dead silo entries are eligible for versioned removal.
        ...
        /// sort order, asynchronously removes the oldest excess dead entries through versioned membership-table mutations.
