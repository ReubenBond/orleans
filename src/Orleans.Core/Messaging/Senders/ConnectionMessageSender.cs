    ...
    internal sealed class ConnectionMessageSender
    {
        ...
        public void Abort()
        {
            if (this.log.IsEnabled(LogLevel.Information))
            {
                this.log.LogInformation(
                    "Aborting connection with remote endpoint {EndPoint}",
        ...
        private async Task Process()
        {
            ...
            try
            {
                ...
                {
                    this.log.LogInformation(
                        "Starting to process messages to remote endpoint {EndPoint}",
                        this.connection.GetRemoteEndPoint());
                }
            ...
            {
                this.log.LogWarning(
                    "Exception processing messages to remote endpoint {EndPoint}: {Exception}",
                    this.connection.GetRemoteEndPoint(),
                    exception);
