...
namespace Orleans.Runtime.Messaging
{
    ...
    internal class SocketConnectionFactory : IConnectionFactory
    {
        ...
        internal static PipeOptions GetPipeOptions(PipeScheduler readerScheduler, PipeScheduler writerScheduler, MemoryPool<byte> memoryPool) => new PipeOptions(
            pool: memoryPool,
...
namespace System.Buffers
{
    ...
    internal class SlabMemoryPool : MemoryPool<byte>
    {
        ...
        private MemoryPoolBlock Lease()
        {
            ...
            void ThrowObjectDisposedException() => throw new ObjectDisposedException("MemoryPool");
        }
