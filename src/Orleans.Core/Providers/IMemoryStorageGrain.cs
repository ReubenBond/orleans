...
namespace Orleans.Storage
{
    ...
    public interface IMemoryStorageGrain : IGrainWithIntegerKey
    {
        ...
        Task<IGrainState<T>> ReadStateAsync<[DynamicallyAccessedMembers(All)] T>(string grainStoreKey);
        ...
        Task<string> WriteStateAsync<[DynamicallyAccessedMembers(All)] T>(string grainStoreKey, IGrainState<T> grainState);
        ...
        Task DeleteStateAsync<[DynamicallyAccessedMembers(All)] T>(string grainStoreKey, string eTag);
    }
}
