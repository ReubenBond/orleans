...
/// </summary>
public sealed partial class LogExtentBuilder : IDisposable, IBufferWriter<byte>
{
    private readonly List<uint> _entryLengths = new();
    ...
    public LogExtentBuilder(PooledBuffer buffer)
    {
        _buffer = buffer;
    }
    ...
    internal void AppendEntry(StateMachineId id, ReadOnlySpan<byte> value)
    {
        ...
        writer.WriteVarUInt32(id.Value);
        writer.Commit();
