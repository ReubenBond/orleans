...
public class DurableList<T> : IList<T>, IDurableStateMachine
{
    ...
    public DurableList(IFieldCodec<T> codec, SerializerSessionPool serializerSessionPool)
    {
        _codec = codec;
    ...
    void IDurableStateMachine.Apply(ReadOnlySequence<byte> logEntry)
    {
        ...
        switch (commandType)
        {
            ...
            case CommandType.Set:
                ApplySet(reader.ReadInt32(), ReadValue(ref reader));
                break;
            case CommandType.Insert:
                ApplyInsert(reader.ReadInt32(), ReadValue(ref reader));
                break;
            case CommandType.Remove:
                ApplyRemoveAt(reader.ReadInt32());
                break;
