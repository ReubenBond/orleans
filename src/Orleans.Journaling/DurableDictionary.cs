...
public class DurableDictionary<K, V> : IDictionary<K, V>, IDurableStateMachine where K : notnull
{
    ...
    private readonly Dictionary<K, V> _items = new();
    private IStateMachineLogWriter? _storage;

    public DurableDictionary(IFieldCodec<K> keyCodec, IFieldCodec<V> valueCodec, SerializerSessionPool serializerSessionPool)
    {
        _keyCodec = keyCodec;
