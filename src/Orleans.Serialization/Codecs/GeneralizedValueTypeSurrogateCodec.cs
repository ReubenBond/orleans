...
namespace Orleans.Serialization.Codecs
{
    ...
    public abstract class GeneralizedValueTypeSurrogateCodec<[DynamicallyAccessedMembers(All)] TField, [DynamicallyAccessedMembers(All)] TSurrogate> : IFieldCodec<TField> where TField : struct where TSurrogate : struct
    {
