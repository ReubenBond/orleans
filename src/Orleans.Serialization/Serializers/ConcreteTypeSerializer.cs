...
namespace Orleans.Serialization.Serializers
{
    ...
    public sealed class ConcreteTypeSerializer<[DynamicallyAccessedMembers(All)] TField, TBaseCodec> : IFieldCodec<TField> where TField : class where TBaseCodec : IBaseCodec<TField>
    {
