...
namespace Orleans.Legacy.Serialization
{
    ...
    public class SerializerFeature
    {
        ...
        /// </summary>
        /// <remarks>
        /// This collection corresponds to the <see cref="Orleans.Legacy.CodeGeneration.SerializerAttribute"/> attribute as well as types which are self-serializing.
        /// </remarks>
    ...
    {
        public SerializerDelegateMetadata(Type target, Copier deepCopier, Serializer serializer, Deserializer deserializer, bool overrideExisting = true)
        {
            this.Target = target;
            this.OverrideExisting = overrideExisting;
