...
namespace Orleans.Legacy.Serialization
{
    ...
    public sealed class SerializationManager : IDisposable
    {
        ...
        private readonly Dictionary<Type, Copier> copiers;
        ...
        {
            // Defaulted to the Large Object Heap threshold.
            this.LargeObjectSizeThreshold = 85_000;
        ...
        private void RegisterGrainReferenceSerializers(GrainInterfaceFeature grainInterfaceFeature)
        {
            ...
            {
                //this.RegisterGrainReferenceSerializers(grainInterface);
            }
        }
        ...
        public void Register(Type t, Copier cop, Serializer ser, Deserializer deser)
        {
        ...
        private void Register(Type t, Copier cop, Serializer ser, Deserializer deser, bool forceOverride)
        {
        ...
        private void Register(Type type, Type serializerType, bool overrideExisting = true)
        {
            ...
            try
            {
                if (type.IsGenericTypeDefinition)
                {
                    ...
                    this.Register(
                        type,
                        copier != null ? DeepCopyGeneric : default(Copier),
                ...
                else
                {
                    ...
                    this.Register(
                        type,
                        CreateDelegate<Copier>(copier, serializerInstance),
        ...
        */
        ...
        private SerializerMethods RegisterConcreteSerializer(Type concreteType, Type genericSerializerType)
        {
            ...
            var concreteCopier = CreateDelegate<Copier>(copier, serializerInstance);
        ...
        internal Copier GetCopier(Type t)
        {
            lock (copiers)
            {
                Copier copier;
