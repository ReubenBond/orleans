...
namespace Orleans.Legacy.Serialization
{
    internal static class BuiltInTypes
    {
        ...
        private static Tuple<Serializer, Deserializer, Copier>
            RegisterConcreteMethods(SerializationManager serializationManager, Type t, string serializerName, string deserializerName, string copierName, Type[] genericArgs = null)
        {
            ...
            var copier = (Copier)concreteCopier.CreateDelegate(typeof(Copier));
            ...
            return new Tuple<Serializer, Deserializer, Copier>(serializer, deserializer, copier);
        }

        public static Tuple<Serializer, Deserializer, Copier>
