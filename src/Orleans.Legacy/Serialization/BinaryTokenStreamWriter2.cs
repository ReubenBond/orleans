...
namespace Orleans.Legacy.Serialization
{
    ...
    internal sealed class BinaryTokenStreamWriter2<TBufferWriter> : IBinaryTokenStreamWriter where TBufferWriter : IBufferWriter<byte>
    {
        ...
        static BinaryTokenStreamWriter2()
        {
            ...
            typeTokens[typeof(LegacyGrainId)] = SerializationTokenType.GrainId;
            typeTokens[typeof(LegacyActivationId)] = SerializationTokenType.ActivationId;
            typeTokens[typeof(SiloAddress)] = SerializationTokenType.SiloAddress;
            typeTokens[typeof(LegacyActivationAddress)] = SerializationTokenType.ActivationAddress;
            ...
            typeTokens[typeof(LegacyResponse)] = SerializationTokenType.Response;
            ...
            writers[typeof(LegacyGrainId)] = (stream, obj) => { stream.Write(SerializationTokenType.GrainId); stream.Write((LegacyGrainId)obj); };
            writers[typeof(LegacyActivationId)] = (stream, obj) => { stream.Write(SerializationTokenType.ActivationId); stream.Write((LegacyActivationId)obj); };
            writers[typeof(SiloAddress)] = (stream, obj) => { stream.Write(SerializationTokenType.SiloAddress); stream.Write((SiloAddress)obj); };
            writers[typeof(LegacyActivationAddress)] = (stream, obj) => { stream.Write(SerializationTokenType.ActivationAddress); stream.Write((LegacyActivationAddress)obj); };
