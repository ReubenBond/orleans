...
namespace Orleans.Storage
{
    ...
    public interface IStorageSerializationPicker
    {
        ...
        SerializationChoice PickDeserializer<T>(string serviceId, string storageProviderInstanceName, IGrainState<T> grainState, string tag = null);
        ...
        SerializationChoice PickSerializer<T>(string serviceId, string storageProviderInstanceName, IGrainState<T> grainState, string tag = null);
    }
}
