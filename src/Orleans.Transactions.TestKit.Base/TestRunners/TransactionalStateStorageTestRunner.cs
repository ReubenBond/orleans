...
namespace Orleans.Transactions.TestKit
{
        ...
        where TState : class, new()
    {
        ...
        protected Func<Task<ITransactionalStateStorage<TState>>> StateStorageFactory { get; set; }
        protected Func<int, TState> StateFactory { get; set; }
        protected Func<EquivalencyAssertionOptions<TState>, EquivalencyAssertionOptions<TState>> AssertConfig { get; set; }
