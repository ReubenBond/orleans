...
namespace Orleans.Runtime.Utilities
{
    ...
    internal static class FactoryUtility
    {
        ...
        public static Factory<TInstance> Create<[DynamicallyAccessedMembers(PublicConstructors)] TInstance>(IServiceProvider serviceProvider)
        {
        ...
        /// <param name="serviceProvider">The service provider.</param>
        /// <returns>A new factory.</returns>
        public static Factory<TParam1, TInstance> Create<TParam1, [DynamicallyAccessedMembers(PublicConstructors)] TInstance>(IServiceProvider serviceProvider)
        {
        ...
        /// <param name="serviceProvider">The service provider.</param>
        /// <returns>A new factory.</returns>
        public static Factory<TParam1, TParam2, TInstance> Create<TParam1, TParam2, [DynamicallyAccessedMembers(PublicConstructors)] TInstance>(IServiceProvider serviceProvider)
        {
        ...
        /// <param name="serviceProvider">The service provider.</param>
        /// <returns>A new factory.</returns>
        public static Factory<TParam1, TParam2, TParam3, TInstance> Create<TParam1, TParam2, TParam3, [DynamicallyAccessedMembers(PublicConstructors)] TInstance>(IServiceProvider serviceProvider)
        {
