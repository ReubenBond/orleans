...
`Invariant` (see [ADO.NET Configuration](../../clusters_and_clients/configuration_guide/adonet_configuration.md)) that identifies the vendor. You may also choose the format in which the data
