...
namespace Grains
{
    ...
    internal class UserAgentGrain : Grain, IUserAgentGrain
    {
        ...
        public Task<List<string>> GetMyPolls() => Task.FromResult(_myPolls.ToList());
        ...
        public async Task<PollState> AddVote(string pollId, int optionId)
        {
            ...
            if (_votedPolls.Contains(pollId)) throw new InvalidOperationException("You have already voted in that poll!");
