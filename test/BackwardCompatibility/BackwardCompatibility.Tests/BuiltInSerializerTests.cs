...
using BackwardCompatibility.Tests;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.Extensions.DependencyInjection.Extensions;
using Orleans;
using Orleans.Concurrency;
using Orleans.Configuration;
using Orleans.Legacy.Serialization;
...
namespace BackwardCompatibility.Tests
{
    ...
    public class BuiltInSerializerTests
    {
        ...
        private SerializationManager InitializeSerializer(SerializerToUse serializerToUse)
        {
            var services = new ServiceCollection()
                .AddOrleansLegacySuppport();
            var fallback = serializerToUse switch
            {
                SerializerToUse.IlBasedFallbackSerializer => typeof(ILBasedSerializer),
                SerializerToUse.BinaryFormatterFallbackSerializer => typeof(BinaryFormatterSerializer),
                SerializerToUse.NoFallback => typeof(SupportsNothingSerializer),
                _ => null,
            };

            if (fallback is not null)
            {
                services.Configure<SerializationProviderOptions>(options => options.FallbackSerializationProvider = fallback);
            }

            var serviceProvider = services.BuildServiceProvider();
            return serviceProvider.GetRequiredService<SerializationManager>();
        }
        ...
        {
            var serializationManager = InitializeSerializer(SerializerToUse.NoFallback);
            Assert.True(
                serializationManager.HasSerializer(typeof(int)),
                $"Should be able to serialize internal type {nameof(Int32)}.");
            Assert.True(
                serializationManager.HasSerializer(typeof(List<int>)),
            ...
            */
            var grainReferenceType = typeof(SerializationManager).Assembly.GetType(
            ...
            Assert.True(
                serializationManager.HasSerializer(typeof(PubSubGrainState)),
                $"Should be able to serialize internal type {nameof(PubSubGrainState)}.");
            /*
            Assert.True(
                serializationManager.HasSerializer(typeof(EventHubBatchContainer)),
                $"Should be able to serialize internal type {nameof(EventHubBatchContainer)}.");
            Assert.True(
                serializationManager.HasSerializer(typeof(EventHubSequenceTokenV2)),
        ...
        public void ValueTupleTypesHasSerializer()
        {
            var serializationManager = InitializeSerializer(SerializerToUse.NoFallback);
            Assert.True(
                serializationManager.HasSerializer(typeof(ValueTuple<int, string>)),
                $"Should be able to serialize internal type {nameof(ValueTuple<int, string>)}.");
        }
        ...
        public void Serialize_ComplexClass(SerializerToUse serializerToUse)
        {
            ...
            var actual = (SomeAbstractClass)OrleansSerializationLoop(serializationManager, expected);
        ...
        public void Serialize_ComplexAccessibleClass(SerializerToUse serializerToUse)
        {
            ...
            var actual = (AnotherConcreteClass)OrleansSerializationLoop(serializationManager, expected);
        ...
        public void Serialize_Type(SerializerToUse serializerToUse)
        {
            ...
            var actual = (Type)OrleansSerializationLoop(serializationManager, expected);
            Assert.Equal(expected.AssemblyQualifiedName, actual.AssemblyQualifiedName);

            // Test serialization of RuntimeType.
            expected = 8.GetType();
            actual = (Type)OrleansSerializationLoop(serializationManager, expected);
            Assert.Equal(expected.AssemblyQualifiedName, actual.AssemblyQualifiedName);
        }
        ...
        public void Serialize_ComplexStruct(SerializerToUse serializerToUse)
        {
            ...
            var actual = (SomeStruct)OrleansSerializationLoop(serializationManager, expected);
        ...
        public void Serialize_ActivationAddress(SerializerToUse serializerToUse)
        {
            ...
            deserialized = OrleansSerializationLoop(serializationManager, addr);
        ...
        public void Serialize_EmptyList(SerializerToUse serializerToUse)
        {
            ...
            var deserialized = OrleansSerializationLoop(serializationManager, list, false);
            ...
            deserialized = OrleansSerializationLoop(serializationManager, list);
        ...
        public void Serialize_BasicDictionaries(SerializerToUse serializerToUse)
        {
            ...
            source1["Hello"] = "Yes";
            source1["Goodbye"] = "No";
            var deserialized = OrleansSerializationLoop(serializationManager, source1);
            ...
            deserialized = OrleansSerializationLoop(serializationManager, source2);
        ...
        public void Serialize_ReadOnlyDictionary(SerializerToUse serializerToUse)
        {
            ...
            var deserialized = OrleansSerializationLoop(serializationManager, readOnlySource1);
            ...
            deserialized = OrleansSerializationLoop(serializationManager, readOnlySource2);
        ...
        public void Serialize_SortedDictionaryWithComparer(SerializerToUse serializerToUse)
        {
            ...
            source1["Hello"] = "Yes";
            source1["Goodbye"] = "No";
            object deserialized = OrleansSerializationLoop(serializationManager, source1);
...
/*
        ...
        public void Serialize_TypeWithOnDeserializedHook(SerializerToUse serializerToUse)
        {
            ...
            var deserialized = OrleansSerializationLoop(serializationManager, input);
            ...
            Assert.Equal(serializationManager, result.Context.GetSerializationManager());
        }
*/
...
#pragma warning restore xUnit2017 // Do not use Contains() to check if a value exists in a collection
        ...
        public void Serialize_Array(SerializerToUse serializerToUse)
        {
            ...
            deserialized = OrleansSerializationLoop(serializationManager, source3);
            ValidateArray<sbyte>(source3, deserialized, "sbyte");

            var source4 = new byte[] { 1, 3, 5 };
            deserialized = OrleansSerializationLoop(serializationManager, source4);
            ValidateArray<byte>(source4, deserialized, "byte");

            var source5 = Enumerable.Repeat(3, (serializationManager.LargeObjectSizeThreshold / sizeof(int)) + 1).ToArray();
            deserialized = OrleansSerializationLoop(serializationManager, source5);
        ...
        */
        ...
        public void Serialize_ArrayOfArrayOfArrays(SerializerToUse serializerToUse)
        {
            ...
            object deserialized = OrleansSerializationLoop(serializationManager, source);
        ...
        public void Serialize_ReadOnlyCollection(SerializerToUse serializerToUse)
        {
            ...
            var deserialized = OrleansSerializationLoop(serializationManager, collection);
        ...
        public void Serialize_UnserializableException()
        {
            ...
            var serializationManager = SerializationTestEnvironment.InitializeWithDefaults(
...
/*
        ...
        */
        ...
        public void Serialize_ObjectIdentity(SerializerToUse serializerToUse)
        {
            ...
            var deserialized = OrleansSerializationLoop(serializationManager, source);
        ...
        public void Serialize_Unrecognized(SerializerToUse serializerToUse)
        {
            ...
            var raw = OrleansSerializationLoop(serializationManager, test1, false);
            ...
            raw = OrleansSerializationLoop(serializationManager, test2);
        ...
        */
        ...
        public void Serialize_Uri_Multithreaded(SerializerToUse serializerToUse)
        {
            ...
            Parallel.For(0, 50, i =>
            {
                ...
                object deserialized = OrleansSerializationLoop(serializationManager, test1);
...
/*
        ...
        public void Serialize_GrainReference(SerializerToUse serializerToUse)
        {
            ...
            object deserialized = OrleansSerializationLoop(serializationManager, input);
        ...
        public void Serialize_GrainReference_ViaStandardSerializer(SerializerToUse serializerToUse)
        {
            ...
            object deserialized = DotNetSerializationLoop(input, serializationManager);
            var grainRef = Assert.IsAssignableFrom<GrainReference>(deserialized); //GrainReference copied as wrong type
        ...
        public void Serialize_GrainBase_ViaStandardSerializer(SerializerToUse serializerToUse)
        {
            ...
            var exc = Assert.Throws<SerializationException>(() => DotNetSerializationLoop(input, serializationManager));
...
#pragma warning restore SYSLIB0011 // Type or member is obsolete
        ...
        public void Serialize_CircularReference(SerializerToUse serializerToUse)
        {
            ...
            var deserialized = (CircularTest1)OrleansSerializationLoop(serializationManager, c1);
            ...
            deserialized = (CircularTest1)OrleansSerializationLoop(serializationManager, c1, true);
            Assert.Equal(c1.CircularTest2.CircularTest1List.Count, deserialized.CircularTest2.CircularTest1List.Count);
            Assert.Same(deserialized, deserialized.CircularTest2.CircularTest1List[0]);
        }
        ...
        {
            var serializationManager = InitializeSerializer(serializerToUse);
            var result = OrleansSerializationLoop(serializationManager, IntEnum.Value2);
            var typedResult = Assert.IsType<IntEnum>(result);
            Assert.Equal(IntEnum.Value2, typedResult);

            var result2 = OrleansSerializationLoop(serializationManager, UShortEnum.Value3);
            ...
            var result3 = OrleansSerializationLoop(serializationManager, test);
            ...
            var result4 = OrleansSerializationLoop(serializationManager, CampaignEnemyType.Enemy3);
        ...
        */
        ...
        {
            var serializationManager = InitializeSerializer(SerializerToUse.BinaryFormatterFallbackSerializer);
            ...
            var result = (SimpleISerializableObject)OrleansSerializationLoop(serializationManager, input);
            Assert.Equal(
                new[]
                {
                    "default_ctor",
        ...
        public void ISerializable_CallbackOrder_Struct()
        {
            ...
            // Verify that our behavior conforms to our expected behavior.
            var result = (SimpleISerializableStruct)OrleansSerializationLoop(serializationManager, input);
            Assert.Equal(
                new[]
                {
                    "serialization_ctor",
        ...
        public void Serialize_DuplicateObjects_ISerializable(SerializerToUse serializerToUse)
        {
            ...
            var deserialized = OrleansSerializationLoop(serializationManager, exception);
