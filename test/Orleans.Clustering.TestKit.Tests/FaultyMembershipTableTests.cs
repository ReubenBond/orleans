...
public sealed class FaultyMembershipTableTests
{
    ...
    [InlineData("SameVersionDeadRemoval", "cleanup", "cleanup version")]
    [InlineData("CleanupRoundsExclusiveCutoff", "cleanup", "left eligible Dead rows")]
    [InlineData("DeleteConfiguredScope", "wrong-cluster", "table integer")]
    ...
    [InlineData("DeletePrefixScopes", "delete-own", "table integer")]
