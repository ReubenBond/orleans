...
namespace UnitTests.StorageTests.Relational
{
    ...
    public class MySqlStorageTests : RelationalStorageTests, IClassFixture<CommonFixture>
    {
        ...
        {
            var (grainType, getGrainReference, grainState) = StorageDataSetPlain<long>.Data[testNum];
        ...
        {
            var (grainType, getGrainReference, grainState) = StorageDataSetGeneric<Guid, string>.Data[testNum];
            await this.PersistenceStorageTests.Store_WriteClearRead(grainType, getGrainReference(this.Fixture.InternalGrainFactory), grainState);
        }
        ...
        {
            var (grainType, getGrainReference, grainState) = StorageDataSetGeneric<long, string>.Data[testNum];
            await this.PersistenceStorageTests.Store_WriteClearRead(grainType, getGrainReference(this.Fixture.InternalGrainFactory), grainState);
        }
        ...
        {
            var (grainType, getGrainReference, grainState) = StorageDataSetGeneric<string, string>.Data[testNum];
        ...
        {
            var (grainType, getGrainReference, grainState) = StorageDataSetGenericHuge<string, string>.Data[testNum];
        ...
        {
            var (grainType, getGrainReference, grainState) = StorageDataSetPlain<Guid>.Data[testNum];
            await this.PersistenceStorageTests.Store_WriteClearRead(grainType, getGrainReference(this.Fixture.InternalGrainFactory), grainState);
        }
        ...
        {
            var (grainType, getGrainReference, grainState) = StorageDataSetPlain<string>.Data[testNum];
            await this.PersistenceStorageTests.Store_WriteClearRead(grainType, getGrainReference(this.Fixture.InternalGrainFactory), grainState);
        }
    }
}