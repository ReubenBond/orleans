...
namespace UnitTests.General
{
    ...
    public class LegacyGrainIdTests
    {
        ...
        public LegacyGrainIdTests(ITestOutputHelper output, TestEnvironmentFixture fixture)
        {
            this.output = output;
        ...
        [Fact, TestCategory("BVT"), TestCategory("GrainReference")]
