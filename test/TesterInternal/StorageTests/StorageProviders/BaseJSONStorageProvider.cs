...
namespace Samples.StorageProviders
{
    ...
    public abstract class BaseJSONStorageProvider : IGrainStorage
    {
        ...
        /// grain state object.
        /// </summary>
        /// <param name="stateName">The name of the grain state.</param>
        ...
        /// <returns>Completion promise for this operation.</returns>
        public Task WriteStateAsync<T>(GrainId grainId, string stateName, IGrainState<T> grainState)
        {
            if (DataManager == null) throw new ArgumentException("DataManager property not initialized");
        ...
        /// <returns></returns>
        public Task ClearStateAsync<T>(GrainId grainId, string stateName, IGrainState<T> grainState)
        {
            if (DataManager == null) throw new ArgumentException("DataManager property not initialized");
