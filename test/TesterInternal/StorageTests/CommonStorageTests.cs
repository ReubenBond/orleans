...
namespace UnitTests.StorageTests.Relational
{
    ...
    internal class CommonStorageTests
    {
        ...
        {
            return Tuple.Create((GrainReference)this.grainFactory.GetGrain(GrainId.Create("test", Guid.NewGuid().ToString())), new GrainState<TestState1> { State = new TestState1(), ETag = version });
        }
